...
$(document).ready(function () {
    ...
    tabladata = $('#tbdata').DataTable({
        ...
        "columns": [
            ...
            {
                "data": "IdColor", "render": function (data, type, row, meta) {
...
function eliminar($id) {
    ...
    swal({
        ...
        function () {
            jQuery.ajax({
                url: $.MisUrls.url._EliminarColor + "?id=" + $id,
                type: "GET",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
