...
namespace VentasWeb.Controllers
{
    public class CompraController : Controller
    {
        ...
        public JsonResult Obtener(string fechainicio, string fechafin, int idproveedor, int idBodega)
        {
            List<Compra> lista = CD_Compra.Instancia.ObtenerListaCompra(Convert.ToDateTime(fechainicio), Convert.ToDateTime(fechafin), idproveedor, idBodega);
