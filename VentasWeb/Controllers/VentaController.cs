...
namespace VentasWeb.Controllers
{
    public class VentaController : Controller
    {
        ...
        public JsonResult ObtenerProductoPorTienda()
        {

            List<ProductoTienda> oListaProductoTienda = CD_ProductoTienda.Instancia.ObtenerProductoTienda();
            oListaProductoTienda = oListaProductoTienda.Where(x =>  x.Stock > 0).ToList();
        ...
        {
            bool respuesta = CD_ProductoTienda.Instancia.ControlarStock(idproducto, cantidad, restar);
        ...
        [HttpPost]
        public JsonResult Devolucion(Venta objeto)
        {
            bool respuesta = false;

            if (objeto.IdVenta > 0)
            {
                respuesta = CD_Venta.Instancia.RealizarDevolucion(objeto);
            }
