...
namespace CapaDatos
{
    public class CD_Compra
    {
                    ...
                    using (XmlReader dr = cmd.ExecuteXmlReader())
                    {
                        while (dr.Read())
                        {
                            ...
                            if (doc.Element("DETALLE_COMPRA") != null)
                            {
                                ...
                                rptDetalleCompra.oTienda = (from dato in doc.Element("DETALLE_COMPRA").Elements("DETALLE_BODEGA")
                                                            select new Tienda()
                                                            {
        ...
        public List<Compra> ObtenerListaCompra(DateTime FechaInicio, DateTime FechaFin, int IdProveedor, int IdBodega)
        {
